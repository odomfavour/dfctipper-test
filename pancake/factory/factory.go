...
func (_Pancake *PancakeCaller) INITCODEPAIRHASH(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Pancake.contract.Call(opts, &out, "INIT_CODE_PAIR_HASH")
...
//
// Solidity: function INIT_CODE_PAIR_HASH() view returns(bytes32)
func (_Pancake *PancakeSession) INITCODEPAIRHASH() ([32]byte, error) {
	return _Pancake.Contract.INITCODEPAIRHASH(&_Pancake.CallOpts)
}

// INITCODEPAIRHASH is a free data retrieval call binding the contract method 0x5855a25a.
//
// Solidity: function INIT_CODE_PAIR_HASH() view returns(bytes32)
func (_Pancake *PancakeCallerSession) INITCODEPAIRHASH() ([32]byte, error) {
	return _Pancake.Contract.INITCODEPAIRHASH(&_Pancake.CallOpts)
}
...
func (_Pancake *PancakeCaller) GetPair(opts *bind.CallOpts, arg0 common.Address, arg1 common.Address) (common.Address, error) {
	var out []interface{}
	err := _Pancake.contract.Call(opts, &out, "getPair", arg0, arg1)
...
//
// Solidity: function getPair(address , address ) view returns(address)
func (_Pancake *PancakeSession) GetPair(arg0 common.Address, arg1 common.Address) (common.Address, error) {
	return _Pancake.Contract.GetPair(&_Pancake.CallOpts, arg0, arg1)
}

// GetPair is a free data retrieval call binding the contract method 0xe6a43905.
//
// Solidity: function getPair(address , address ) view returns(address)
func (_Pancake *PancakeCallerSession) GetPair(arg0 common.Address, arg1 common.Address) (common.Address, error) {
	return _Pancake.Contract.GetPair(&_Pancake.CallOpts, arg0, arg1)
}
...
func (_Pancake *PancakeTransactor) SetFeeTo(opts *bind.TransactOpts, _feeTo common.Address) (*types.Transaction, error) {
	return _Pancake.contract.Transact(opts, "setFeeTo", _feeTo)
}

// SetFeeTo is a paid mutator transaction binding the contract method 0xf46901ed.
//
// Solidity: function setFeeTo(address _feeTo) returns()
func (_Pancake *PancakeSession) SetFeeTo(_feeTo common.Address) (*types.Transaction, error) {
	return _Pancake.Contract.SetFeeTo(&_Pancake.TransactOpts, _feeTo)
}

// SetFeeTo is a paid mutator transaction binding the contract method 0xf46901ed.
//
// Solidity: function setFeeTo(address _feeTo) returns()
func (_Pancake *PancakeTransactorSession) SetFeeTo(_feeTo common.Address) (*types.Transaction, error) {
	return _Pancake.Contract.SetFeeTo(&_Pancake.TransactOpts, _feeTo)
}
...
func (_Pancake *PancakeTransactor) SetFeeToSetter(opts *bind.TransactOpts, _feeToSetter common.Address) (*types.Transaction, error) {
	return _Pancake.contract.Transact(opts, "setFeeToSetter", _feeToSetter)
}

// SetFeeToSetter is a paid mutator transaction binding the contract method 0xa2e74af6.
//
// Solidity: function setFeeToSetter(address _feeToSetter) returns()
func (_Pancake *PancakeSession) SetFeeToSetter(_feeToSetter common.Address) (*types.Transaction, error) {
	return _Pancake.Contract.SetFeeToSetter(&_Pancake.TransactOpts, _feeToSetter)
}

// SetFeeToSetter is a paid mutator transaction binding the contract method 0xa2e74af6.
//
// Solidity: function setFeeToSetter(address _feeToSetter) returns()
func (_Pancake *PancakeTransactorSession) SetFeeToSetter(_feeToSetter common.Address) (*types.Transaction, error) {
	return _Pancake.Contract.SetFeeToSetter(&_Pancake.TransactOpts, _feeToSetter)
}
